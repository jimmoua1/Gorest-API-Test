package demo.Assessment.TasksToDo10_Collection_Hash_and_Sets.KarasTasksToDo10_ProblemSolving.Problem_5;
    ...
    public static void charFreqMap(String string){
        ...
        for(int i = 0; i < string.length(); i++){
            if(frequencyMap.get(string.charAt(i)) != 0){
                ...
                System.out.print(frequencyMap.get(string.charAt(i)) + " ");
